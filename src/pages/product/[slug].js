    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-10 mx-auto">
        <div className="sm:ml-32 mx-auto flex flex-wrap">
          <img
            alt="ecommerce"
            className="sm:w-72 sm:mt-6 sm:h-96 object-cover object-center rounded"
            src={product.img}
          />
          {/* <Image 
          alt={product.title}
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="pin mt-6 flex space-x-2 text-sm">
              ...
              <button
                ...
                className="text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none rounded-md hover:bg-pink-600"
              >
                Check
              </button>
            </div>
            ...
            {service && service != null && (
              <div className="text-green-700">Yay! Pincode is serviceable</div>
            )}
          </div>
        </div>
      </div>
