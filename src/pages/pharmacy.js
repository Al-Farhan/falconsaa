...
const Pharmacy = ({ products }) => {
  ...
  return (
    <>
      <Head>
        <title>
          Buy pharmacy books from Falconsaa. Fulfill the dream of your insides
          falcon.
        </title>
        <meta
          name="description"
      ...
      <div className="bg-white mt-2">
        {products.length == 0 ? (
          <div className="text-lg text-center text-gray-500 h-44">
            Sorry product will be available soon.
          </div>
        ) : (
          <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            <h2 className="text-2xl font-bold tracking-tight text-gray-900">
              Explore Pharmacy Books
            </h2>
...
export async function getServerSideProps(context) {
  ...
  let products = await Product.find({ category: "Pharmacy" });
